...
const PostIt = ({originalBg, content, nickname, own, comments}) => {
    ...
    return<>
        <PostItWrap bg={bg}>
            ...
            {own?<MyIconItems nickname={nickname} status={status}></MyIconItems>:<OtherIconItems nickname={nickname} like={like}></OtherIconItems>}
            <form>
                <input></input>
            </form>
